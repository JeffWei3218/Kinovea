...
namespace Kinovea.Camera.IDSpeak
{
    ...
    public static class BitmapFactory
    {
        ...
        public static void CreateBitmap(out Bitmap bitmap, int width, int height, int stride, bool color, IntPtr scan0)
        {
            bitmap = new Bitmap(width, height, stride, GetFormat(color), scan0);
